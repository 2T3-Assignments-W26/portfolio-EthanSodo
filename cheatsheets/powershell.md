...
![PowerShell_logo](.\PowerShell_5.0_icon.png)
...
> *"PowerShell is great because we had a series of rockstar engineers add their awesomeness to the project." ( from the [interview](https://evrone.com/blog/jeffrey-snover-interview) with Jeffrey Snover, PowerShell Inventor)*
...
* **`Show-Process`**: Displays all running processes.
